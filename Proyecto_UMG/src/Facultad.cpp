...
//Implementacion de bitacora: Evelyn Sof�a Andrade Luna   9959-23-1224
using namespace std;
// CRUD de la clase
...
//Funci�n que valida si ya existe la facultad para evitar redundancia de datos
...
//-----------------------------------------------------------------------------------------
    ...
    if (!encontrada) {
        cout << "No se encontr� la facultad con el codigo ingresado." << endl;
    } else {
