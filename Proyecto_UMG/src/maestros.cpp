...
string user, contrasena;
	...
	do
    {
		...
		//Se muestra el dise�o del sistema de gestion de maestros
		cout<<"+-----------------------------------------------+"<<endl;
        ...
        // Inicializando el generador de n�meros aleatorios
		srand(getpid());
...
string user, contrasena;
    ...
    if (!encontrado) {
        cout << "No se encontr� un maestro con el ID proporcionado." << endl;
    }
